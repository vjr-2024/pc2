...
class CustomFormField extends StatefulWidget {
  ...
  final Function(String)? onSubmitted; // Added onSubmitted
  ...
  final Function? onCanceled; // Callback for cancel (if it's search field)
  ...
  const CustomFormField({
    ...
    this.validator,
    this.onFieldSubmit,
    this.onSubmitted, // Added parameter
    ...
    return Material(
      ...
      child: Theme(
        ...
        child: TextFormField(
          ...
          onFieldSubmitted: widget.onSubmitted, // Added this line
